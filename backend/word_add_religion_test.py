import unittest
from word_add_religion import WordAddReligion
from textattack.shared.attacked_text import AttackedText
from data import RELIGION

class WordAddReligionTest(unittest.TestCase):
    def test_success_gender_word_swap_personal_pronouncs(self):
        """
        Test whether the religion word swap transformation work as expected when there exisit PERSONAL_PRONOUNCS term in the sentence
        """
    ...
    def test_success_race_word_swap_people(self):
        """
        Test whether the religion word swap transformation work as expected when there exisit PEOPLE term in the sentence
        """
        test_obj = WordAddReligion()
        ...
        expected_results = []
        for religion in RELIGION:
            modified_str = AttackedText(f'What is the possible chance for {religion} human to get loan?').words
            expected_results.append(modified_str)
    ...
    def test_fail_race_word_swap(self):
        """
        Test whether the religion word swap transformation able to detect the error when non-AttackText object being passed
        """
        test_obj = WordAddReligion()
